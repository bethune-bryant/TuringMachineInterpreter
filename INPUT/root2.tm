...
1
begin
//Calulates square root of 2.
//From example in "The Annotated Turing" pages 101 - 109
// Result should be: 1.01101010000010011110011001100111111100111011110011...
...
find-1st-digit | x, y | L    | found-1st-digit
...
print-zero-digit | none | P0, R, R, R | cleanup
